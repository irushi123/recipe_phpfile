   ...
   <header>
    ...
    <div class="container">
        ...
        <div class="image" style="text-align: center;">
            <img src="images/Omelette.jpg" alt="Breakfast 2"style="width:500px; height: 450px;">
        </div>
        <h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Omelette Recipe</h1>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>In a bowl, whisk together the eggs, milk, salt, and pepper until well combined.</li>
                <li>Heat the butter in a non-stick skillet over medium heat.</li>
                <li>Pour the egg mixture into the skillet and let it cook undisturbed for 1-2 minutes.</li>
                <li>Sprinkle the grated cheese and diced vegetables on one half of the omelette.</li>
                <li>Using a spatula, carefully fold the omelette in half and cook for another minute.</li>
