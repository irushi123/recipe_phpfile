...
<div class="container">
    ...
    <img src="images/chicken-stir-fry-recipe.jpg" alt="Chicken Stir Fry"style="width:500px; height:450px;">
</div>
<h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Chicken Stir Fry Recipe </h1>
...
<div class="ingredients">
    ...
    <ul>
        ...
        <li>1 tbsp cornstarch (optional for sauce thickening)</li>
    </ul>
    <div class="instructions">
        <h2 style="color: brown; font-style: italic;">Instructions:</h2>
    <ol>
        <li>Heat oil in a wok or skillet.</li>
        <li>Sauté the chicken until fully cooked.</li>
        <li>Add the vegetables and stir fry for 5 minutes.</li>
        <li>Mix soy sauce, oyster sauce, and cornstarch. Pour over the stir fry.</li>
        <li>Cook until the sauce thickens slightly. Serve with rice.</li>
    </ol>
</div>
<!-- Footer Section -->
<footer>
