...
<body>
   ...
   <header>
    ...
    <div class="container">
        ...
        <div class="image" style="text-align: center;">
            <img src="images/popcorn. jpg.jpeg"style="width:500px; height:450px;">
        </div>
        <h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Popcorn</h1>
        ...
        <ul>
            ...
            <li>Salt to taste</li>
            <li>Optional: Parmesan cheese, garlic powder, or paprika for seasoning</li>
        </ul>
    </div>
   ...
   <div class="instructions">
    <h2 style="color: brown; font-style: italic;">Instructions:</h2>
        <ol>
            <li>Heat a large pot over medium heat and add 1 tablespoon of butter.</li>
            <li>Add the popcorn kernels to the pot, cover with a lid, and shake the pot occasionally until the popping slows down.</li>
            <li>Once the popping has stopped, remove the pot from heat.</li>
            <li>While the popcorn is popping, melt the remaining butter in a separate small pan.</li>
            <li>Drizzle the melted butter over the popcorn, and season with salt (and any optional seasonings).</li>
