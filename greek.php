...
<body>
    <div class="container">
        <!-- Image Section -->
        <div class="image">
            <img src="images/greek salads.jpg" alt="Greek Salad" style="width: 500px; height: 450px;">
        </div>
        <h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Greek Salad Recipe</h1>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Combine tomatoes, cucumber, red onion, green pepper, and olives in a large bowl.</li>
                <li>Add the crumbled feta cheese on top.</li>
                <li>In a small bowl, whisk together olive oil, red wine vinegar, oregano, salt, and black pepper.</li>
                <li>Drizzle the dressing over the salad and gently toss to combine.</li>
                <li>Let the salad sit for 10-15 minutes to allow the flavors to meld together.</li>
                <li>Serve and enjoy your fresh Greek salad!</li>
            </ol>
        </div>
    </div>
