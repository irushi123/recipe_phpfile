...
<body>
    <div class="container">
        ...
        <!-- Image Section -->
        <div class="image">
            <img src="images/casear salads.jpg" alt="Caesar Salad" style="width: 500px; height: 450px;">
        </div>
        <h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Caesar Salad Recipe</h1>
        <!-- Ingredients Section -->
        <div class="ingredients">
            ...
            <ul style= "color:black; font-size: 15px;">
                ...
                <li>1/3 cup Caesar salad dressing</li>
                <li>2 grilled chicken breasts, sliced (optional)</li>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Wash and dry the romaine lettuce thoroughly. Chop it into bite-sized pieces.</li>
                <li>In a large salad bowl, combine the lettuce, croutons, and Parmesan cheese.</li>
                <li>Drizzle the Caesar dressing over the salad and toss well to evenly coat the ingredients.</li>
                <li>If desired, top the salad with sliced grilled chicken for added protein.</li>
