...
<body>
   ...
   <header>
    ...
    <div class="container">
        ...
        <h1 style="color:rgb(46, 116, 182); font-family:Fantasy; font-size: 50px;">Chips and Salsa</h1>
   ...
   <div class="instructions">
    <h2 style="color: brown; font-style: italic;">Instructions:</h2>
        <ol>
            <li>In a bowl, combine chopped tomatoes, onion, jalapeño (if using), and cilantro.</li>
            <li>Squeeze the juice of one lime over the mixture.</li>
